...
To test this hypothesis, we look at the relationship between two variables: breakfast_frequency and study_productivity. The variable breakfast_frequency is an ordinal variable because it ranges from "Never" to "Every day". The variable study_productivity is also an ordinal variable measured on a 1-5 Likert scale, where higher values indicate higher perceived study productivity.

## Exploratory Data Analysis

For the exploratory data analysis, we calculated the average perceived study productivity for each breakfast-frequency category and visualized it with a line chart. This visualization helps us identifying potential trends in study productivity across different breakfast habits.
...
The line chart shows a slight positive trend between breakfast frequency and perceived study productivity. Students who eat breakfast more frequently tend to report higher average productivity scores. Although the differences are relatively small, the overall pattern is consistent with H1.

## Descriptive Inference

To further examine the pattern observed in the linechart, summary statistics were calculated for perceived study productivity grouped by breakfast frequency. This allows comparison of productivity scores across the different breakfast-frequency categories.
...
The descriptive statistics indicate a slight increase in perceived study productivity with higher breakfast frequency. Students who eat breakfast every day report the highest average productivity score (3.66), while those who eat breakfast one to two days per week report the lowest (3.29). Overall, the descriptive results are also consistent with H1.
...
Overall, the results suggest a statistically significant positive relationship between breakfast frequency and perceived study productivity. Therefore, Hypothesis 1 is supported by the data.
